...
export async function peopleSearchViaApollo(filters = {}, options = {}) {
  ...
  const listMapping = { job_title: "person_titles", seniority: "person_seniorities", location: "person_locations" };
  ...
  const company = clean(Array.isArray(filters.company) ? filters.company.join(" ") : filters.company);
