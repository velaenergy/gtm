export const OUTREACH_SUBJECT = "Quick intro + seeking advice";
...
function founderColdTemplate(senderName) {
  const introduction = senderName === "Tony"
    ? "I'm Tony, one of the founders of Vela Energy. We're an early-stage startup building AI agents that help large energy users get powered on faster. I left Tesla to build Vela full-time, and my co-founder Tarun and I are still spending a lot of time learning how these problems show up in practice."
    : "I'm Tarun, one of the founders of Vela Energy. We're an early-stage startup building AI agents that help large energy users get powered on faster. My co-founder Tony left Tesla to build Vela with me full-time, and we're still spending a lot of time learning how these problems show up in practice.";
  return `Hi {{firstName}},

I came across your profile and wanted to reach out after reading about {{workNoteInline}}.
...
export function buildWorkNote(profile = {}) {
  ...
  const lead = company
    ? `the work you’ve been doing at ${company}`
    : "the work you’ve been doing across energy and infrastructure";
