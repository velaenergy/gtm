...
import { normalizeTargetFit } from "../lib/target-fit.js";
...
export async function verifyTargetFit(input, { apiKey, model = "gpt-5.4-mini", fetchImpl = fetch } = {}) {
  ...
  return normalizeTargetFit(JSON.parse(output));
}
