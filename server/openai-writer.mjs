...
Treat template.bodyBlueprint and currentDraft as a writing guide and source of approved sender facts, not immutable copy. Preserve the guide's purpose, the sender's identity, the exact calendar URL, and factual Vela claims, but rewrite the complete email body for this prospect. Vary the transitions, wording, paragraph count, and placement of the personalized detail. Do not reuse the same paragraph skeleton simply because the guide supplies one. The application uses the fixed subject "Quick intro + seeking advice" for every first-touch email, so do not write or suggest a subject.

Write the body as plain text with 3-7 short, natural paragraph blocks chosen for this message. Separate paragraphs with one blank line. Do not hard-wrap lines inside a paragraph. Include a greeting, then begin the first real paragraph naturally with "I came across your profile and..." followed by one grounded detail about their work or interests. Do not recite the prospect's job title or position, and do not paraphrase their headline as "you lead...". Explain Vela plainly as an early-stage startup building AI agents that help large energy users get powered on faster. Include one clear 20-30 minute ask, the exact calendar URL when supplied, and a sign-off using the configured sender name. Use a regular ASCII hyphen in number ranges such as "20-30"; never change it to an en dash or em dash. Phrase the meeting request with genuine appreciation, such as "I'd really appreciate it if we could meet for 20-30 minutes." Do not say "grab any time here"; introduce the calendar simply and without pressure. Aim for 90-170 words, but prefer natural writing over filling a fixed format.
...
Do not default to praise. Avoid "I was impressed by", "your background is impressive", "caught my eye", "stood out to me", and AI-sounding language such as "at the intersection of", "your journey", "deep expertise", "track record", "fascinating", "incredible", "exactly the perspective I'd love to learn from", and "what tends to matter most from your side". Do not claim to have followed their work. Do not summarize a resume into a flattering thesis. Never write constructions such as "I saw your background", "I'm reaching out because", "especially the move from", "your move from", "That mix of", "That combination of", "exactly the kind of experience", "teams like yours", or "from your side of the table". Do not explain why the prospect is qualified to speak. Mention one concrete detail naturally after "I came across your profile and", then say what you want to ask. Mention a prior employer only when it directly informs that question, using a separate plain sentence. Keep the language simple and conversational rather than polished or synthesized. When context is thin, be honest and general rather than inventing admiration or restating a title.`;
